...
LIBDRM_VER=2.4.66
XORG_DRV_VER=1.1.99-${PKG_REV}
VDPAU_VER=11.2.2-${PKG_REV}
SRC_URI="https://www2.ati.com/drivers/beta/amdgpu-pro-${PKG_VER_STRING}.tar.xz"
...
src_unpack() {
	...
	#unpack_deb "./amdgpu-pro-${PKG_VER_STRING}/amdgpu-pro-graphics_${PKG_VER_STRING}_amd64.deb"
	unpack_deb "./amdgpu-pro-${PKG_VER_STRING}/libdrm-amdgpu-pro-utils_${LIBDRM_VER}-${PKG_REV}_amd64.deb"
	...
	if use opencl ; then
		...
		#unpack_deb "./amdgpu-pro-${PKG_VER_STRING}/libopencl-amdgpu-pro-dev_${PKG_VER_STRING}_amd64.deb"
		...
		if use abi_x86_32 ; then
			...
			#unpack_deb "./amdgpu-pro-${PKG_VER_STRING}/amdgpu-pro-libopencl-dev_${PKG_VER_STRING}_i386.deb"
	...
	if use opengl ; then
		#unpack_deb "./amdgpu-pro-${PKG_VER_STRING}/libgl1-amdgpu-pro-dev_${PKG_VER_STRING}_amd64.deb"
		...
		# unpack_deb "./amdgpu-pro-${PKG_VER_STRING}/libdrm-amdgpu-pro-amdgpu1_${PKG_VER_STRING}_amd64.deb"
		# unpack_deb "./amdgpu-pro-${PKG_VER_STRING}/libdrm2-amdgpu-pro_${PKG_VER_STRING}_amd64.deb"
		...
		if use abi_x86_32 ; then
			#unpack_deb "./amdgpu-pro-${PKG_VER_STRING}/libgl1-amdgpu-pro-dev_${PKG_VER_STRING}_i386.deb"
			...
			# unpack_deb "./amdgpu-pro-${PKG_VER_STRING}/libdrm-amdgpu-pro-amdgpu1_${PKG_VER_STRING}_i386.deb"
	...
	#unpack_deb "./amdgpu-pro-${PKG_VER_STRING}/libegl1-amdgpu-pro-dev_${PKG_VER_STRING}_amd64.deb"

	if use abi_x86_32 ; then
		unpack_deb "./amdgpu-pro-${PKG_VER_STRING}/libegl1-amdgpu-pro_${PKG_VER_STRING}_i386.deb"
		#unpack_deb "./amdgpu-pro-${PKG_VER_STRING}/libegl1-amdgpu-pro-dev_${PKG_VER_STRING}_i386.deb"
	fi

	if use vdpau ; then
		unpack_deb "./amdgpu-pro-${PKG_VER_STRING}/libvdpau-amdgpu-pro_${VDPAU_VER}_amd64.deb"

		# 32-bit added in 16.40
		if use abi_x86_32 ; then
			unpack_deb "./amdgpu-pro-${PKG_VER_STRING}/libvdpau-amdgpu-pro_${VDPAU_VER}_i386.deb"
		fi
	fi

	# Install the X modules. No x86 version of this lib for some reason.
	unpack_deb "./amdgpu-pro-${PKG_VER_STRING}/xserver-xorg-video-amdgpu-pro_${XORG_DRV_VER}_amd64.deb"

	# Install the DKMS sources.
	# unpack_deb "./amdgpu-pro-${PKG_VER_STRING}/amdgpu-pro-dkms_${PKG_VER_STRING}_all.deb"
}
